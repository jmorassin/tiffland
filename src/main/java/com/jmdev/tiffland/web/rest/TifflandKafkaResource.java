...
@RestController
@RequestMapping("/api/tiffland-kafka")
public class TifflandKafkaResource {

    private final Logger log = LoggerFactory.getLogger(TifflandKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaSender<String, String> sender;

    public TifflandKafkaResource(KafkaProperties kafkaProperties) {
